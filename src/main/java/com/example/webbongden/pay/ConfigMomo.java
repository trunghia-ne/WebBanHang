...
public class ConfigMomo {
    ...
    public static final String RETURN_URL = "https://webbongden.khacthienit.click/pay/momoReturn";
    public static final String IPN_URL = "https://webbongden.khacthienit.click/pay/momoNotify";
